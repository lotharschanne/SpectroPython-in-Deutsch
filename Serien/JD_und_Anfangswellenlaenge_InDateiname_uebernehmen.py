...
# -*- coding: utf-8 -*-
"""
Das Skript schreibt das Beobachtungsdatum als JD und die Anfangswellenlänge an 
den Anfang der Dateinamen einer Serie von Spektren und speichert das fits mit 
dem neuen Namen als fits ab.
...
for i in range(len(filelist)):
    ...
    name = 'JD_'+str(JD)+'Anfangswellenlänge_' + \
